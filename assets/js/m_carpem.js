...
function master(){  
    tabel =  $("#m_carpem").DataTable({
        ...
        ajax: {
            url: 'Master_carpem/get_datatables',
            type: 'POST',
            dataType: 'json'
        },
        columnDefs: [
...
function hapus(a){ 
    swal({
        title: "Hapus Master Cara Pembayaran",
...
function edit(a) {
    var m_url = 'Master_carpem/caridata';
    var data = { edKode: a };
    $.ajax({
        type: "POST",
        dataType: "json",
