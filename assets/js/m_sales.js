...
function master(){  
    tabel =  $("#m_sales").DataTable({
        ...
        ajax: {
            url: 'Master_sales/get_datatables',
            type: 'POST',
            dataType: 'json'
        },
        columnDefs: [
...
function edit(a) {
    var m_url = 'Master_sales/caridata';
    var data = { edKode: a };
    $.ajax({
        type: "POST",
        dataType: "json",
