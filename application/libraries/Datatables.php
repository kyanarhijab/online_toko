  ...
  */
  class Datatables
  {
    ...
    */
    ...
    //  $this->ci->load->model('M_conf', 'conf');
    //  $this->ci->db=$this->ci->conf->_cek_koneksi();
    }
    ...
    */
    ...
    public function query_sql_test()
    {
        ...
        if( $this->raw_sql === '' )
            ...
            $return = $this->ci->db->query($this->raw_sql);
    ...
    */
    private function get_total_results($filtering = FALSE)
    {
        ...
        if( $this->raw_sql === '' ) {
            ...
            $query = $this->ci->db->query($this->raw_sql);
        }
