        ...
        <div class="card">
            ...
            <div class="body">
                <form id="fm_add">
                    ...
                    <div class="row clearfix">
                        <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                            <label>Nama Cara Pembayaran</label>
                        </div>
        ...
        <div class="card">
            ...
            <button type="button" class="btn btn-danger btn-sm waves-effect" id="bt_add"><i class="material-icons">add</i>  Tambah Data </button>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable display select" cellspacing="0" width="100%" id="m_carpem" style="cursor:pointer;">
                        <thead>
                            <tr>
                                <th style="text-align:left">Kode Cara Pembayaran</th>
                                <th style="text-align:left">Nama Cara Pembayaran</th>
                                <th>Aksi</th>
                            </tr>
                        </thead>
                    </table>
