        ...
        <div class="card">
            ...
            <button type="button" class="btn btn-danger btn-sm waves-effect" id="bt_add"><i class="material-icons">add</i>  Tambah Data </button>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped table-hover dataTable display select" cellspacing="0" width="100%" id="m_merk" style="cursor:pointer;">
                        <thead>
                            <tr>
                                <th style="text-align:left">Kode Merk</th>
